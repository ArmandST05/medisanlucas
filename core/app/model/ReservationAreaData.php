<?php
class ReservationAreaData {
	public static $tablename = "reservation_areas";
	...
	public static function getAll(){
		...
		return Model::many($query[0],new ReservationAreaData());
	}

	public static function getById($id){
		$sql = "SELECT * FROM ".self::$tablename." WHERE id = '$id'";
		$query = Executor::doit($sql);
		return Model::one($query[0],new ReservationAreaData());
	}
}
